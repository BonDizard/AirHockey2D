...
public class GameLobbyManager : MonoBehaviour {
    ...
    private async Task<Allocation> AllocateRelay() {
        try {
            Allocation allocation = await RelayService.Instance.CreateAllocationAsync(GameMultiplayerManager.MAX_PLAYERS_ALLOWED - 1);
            return allocation;
        }
    ...
    public async void CreatLobby(string lobbyName, bool isPrivate) {
        try {
            ...
            joinedLobby = await LobbyService.Instance.CreateLobbyAsync(lobbyName, GameMultiplayerManager.MAX_PLAYERS_ALLOWED, new CreateLobbyOptions {
                IsPrivate = isPrivate,
            });
